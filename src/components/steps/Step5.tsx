...
//   const marge = prixCreme * 0.26; // Marge 26%
...
//       total: ((depistage * 0.66) * prixCreme).toFixed(2) + " €", // CA = total patients * prix crème
//       net: ((depistage * 0.66) * marge).toFixed(2) + " €", // Net = total patients * marge
//     },
//     {
//       key: "2",
//       pourcentage: "50%",
//       totalPatients: (depistage * 0.50).toFixed(2), // Total patients 50%
//       total: ((depistage * 0.50) * prixCreme).toFixed(2) + " €", // CA = total patients * prix crème
//       net: ((depistage * 0.50) * marge).toFixed(2) + " €", // Net = total patients * marge
//     },
//     {
//       key: "3",
//       pourcentage: "33%",
//       totalPatients: (depistage * 0.33).toFixed(2), // Total patients 33%
//       total: ((depistage * 0.33) * prixCreme).toFixed(2) + " €", // CA = total patients * prix crème
//       net: ((depistage * 0.33) * marge).toFixed(2) + " €", // Net = total patients * marge
//     },
//   ];
